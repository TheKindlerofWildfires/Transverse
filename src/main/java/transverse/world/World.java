...
import transverse.collision.AABB;
import org.joml.*;

import transverse.entity.*;
...
public class World {
    ...
    public World(String world, Camera camera) {
        try {
            BufferedImage tile_sheet = ImageIO.read(new File("src/main/resources/levels/" + world + "/tiles.png"));
            BufferedImage entity_sheet = ImageIO.read(new File("src/main/resources/levels/" + world + "/entities.png"));
